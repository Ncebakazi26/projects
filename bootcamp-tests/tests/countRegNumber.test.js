describe('The counting registration number function(countRegNumber())', function () {
    it('should count how many registration numbers are in the string and return 3', function () {
        assert.equal(3, countRegNumber('CA 182736,CY 523519,CJ 812328'))
    });
    it('Should count how many registration numbers are in the string and return 2', function () {
